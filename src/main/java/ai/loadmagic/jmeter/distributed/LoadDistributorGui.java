...
public class LoadDistributorGui extends AbstractConfigGui {
    ...
    private JPanel createInfoPanel() {
        ...
        info.setText(
            ...
            + "HOW TO USE:\n\n"
            + "This plugin auto-activates when -Jgenerator.id and\n"
            + "-Jgenerator.count are set. No test plan element is required.\n\n"
            + "Simply start each generator with:\n\n"
            ...
            + "NOTES:\n"
            + "  This config element is optional — kept for backward\n"
            + "  compatibility. The plugin works with or without it.\n"
